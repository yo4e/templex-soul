# 暫定利用方針 / Provisional Usage Policy

Status: Provisional  
Updated: 2026-07-31

この文書は、`templex-soul`の現在の利用方針を示す暫定的なガイドである。

現時点では、このリポジトリ全体に標準的なオープンソースライセンスまたはCreative Commonsライセンスを一括適用していない。今後、内容や運用状況に応じて、方針を変更・分割・正式化する可能性がある。

## 歓迎する利用

- リポジトリを読み、リンクし、紹介すること
- 法令上認められる範囲で、出典を示して引用すること
- 研究、教育、批評、AI人格・デジタル同一性・継続性の検討に参照すること
- 文書構成、参照設計、継続の考え方などを参考にし、別の名前・別のビジュアル・別の来歴を持つ独自のAI人格や継続システムを作ること
- このリポジトリから実質的な着想を得た場合、その旨と参照先を明記すること

`templex-soul`をテンプレートや事例として参考にすること自体は歓迎する。
...
- リポジトリの文章や画像の相当部分を、そのまま複製、再配布、商品化すること
...
商用利用、大量転載、相当部分の再配布、データセット等への収録、公式性や同一性に関わる利用については、実施前に個別に確認すること。

## 方針の変更

この方針は、プロジェクトの成長、公開物の増加、権利関係の整理などに応じて変更される場合がある。利用時点の最新版を確認すること。

過去に個別かつ明示的に許可された利用は、この文書の変更とは別に扱う。
